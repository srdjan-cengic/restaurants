class CouponesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @coupone.save
        format.html { redirect_to @coupone, notice: 'Coupone was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @coupone.update(coupone_params)
        format.html { redirect_to @coupone, notice: 'Coupone was successfully updated.' }
  ...
  def destroy
    @coupone.destroy
    respond_to do |format|
      format.html { redirect_to coupones_url }
      format.json { head :no_content }
    end
  end
